                    ...
                    <form method="post" action="../php/confAddContent.php" class="col s12" enctype="multipart/form-data">
                        <div class="row">
                            <div class="input-field col s6">
                                <input name="name" placeholder="TextBox 1" id="name" type="text" class="validate" value="" required>
                            </div>
                            <div class="input-field col s6">
                                <input name="author" placeholder="TextBox 2" id="author" type="text" class="validate" value="" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col s6">
                                <input name="pagesNumber" placeholder="TextBox NUmber 3" id="pagesNumber" type="number" class="validate" value="" required>
                            </div>
                            <div class="input-field col s6">
                                <input name="editor" placeholder="TextBox 4" id="editor" type="text" class="validate" value="" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col s12">
                                <p>
                                    <label>Date TextBox</label>
                                </p>
                                <input name="editionDate" placeholder="Date TextBox" id="editionDate" type="date" class="validate" value="">
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col s12">
                                <textarea name="Resum" placeholder="TextBox 5" id="Resum" class="validate" value=""></textarea>
                            </div>
                        </div>
                        <div class="row">
